...
//     version 1.7.0
//     from Assets/_Presentation/InputSystem/GlobalIInputActions.inputactions
//
...
public partial class @GlobalIInputActions: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @GlobalIInputActions()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""GlobalIInputActions"",
    ""maps"": [
        {
    ...
    {
        private @GlobalIInputActions m_Wrapper;
        public GlobalActionMapActions(@GlobalIInputActions wrapper) { m_Wrapper = wrapper; }
